    ...
    <div class="relative flex items-center justify-between h-16">
      ...
      <div class="hidden sm:flex sm:ml-6">
        <div class="flex space-x-4">
          <a href="#" class="text-white px-3 py-2 rounded-md text-sm font-medium bg-green-900">Inicio</a>
          <a href="#productos" class="text-white hover:bg-green-700 px-3 py-2 rounded-md text-sm font-medium">Compra de Productos</a>
          <a href="#nosotros" class="text-white hover:bg-green-700 px-3 py-2 rounded-md text-sm font-medium">Acerca de Nosotros</a>
          <a href="#contacto" class="text-white hover:bg-green-700 px-3 py-2 rounded-md text-sm font-medium">Contáctanos</a>
        </div>
      </div>
...
<div class="sm:hidden bg-green-800" id="mobile-menu" style="display: none;">
  <div class="px-2 pt-2 pb-3 space-y-1">
    <a href="#" class="text-white block px-3 py-2 rounded-md text-base font-medium bg-green-900">Inicio</a>
    <a href="#productos" class="text-white hover:bg-green-700 block px-3 py-2 rounded-md text-base font-medium">Compra de Productos</a>
    <a href="#nosotros" class="text-white hover:bg-green-700 block px-3 py-2 rounded-md text-base font-medium">Acerca de Nosotros</a>
    <a href="#contacto" class="text-white hover:bg-green-700 block px-3 py-2 rounded-md text-base font-medium">Contáctanos</a>
  </div>
</div>
...
<section id="contacto" class="bg-green-800 py-12">
  <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
    ...
    <a href="mailto:info@acopiadorajr.com" class="bg-white text-green-800 px-6 py-3 rounded-md font-medium hover:bg-gray-200">Enviar correo</a>
  </div>
</section>
